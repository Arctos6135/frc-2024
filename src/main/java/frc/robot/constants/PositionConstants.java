...
public class PositionConstants {
    ...
    public static final Pose2d RED_AMP = new Pose2d(16.54 - 0.8, 6.7, Rotation2d.fromDegrees(180-60));
    ...
    public static final Pose2d BLUE_AMP = new Pose2d(0.8, 6.7, Rotation2d.fromDegrees(60));
