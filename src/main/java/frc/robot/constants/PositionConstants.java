...
public class PositionConstants {
    ...
    public static final Pose2d RED_AMP = new Pose2d(16.54 - 0.92, 6.91, Rotation2d.fromDegrees(180-50));
    ...
    public static final Pose2d BLUE_AMP = new Pose2d(0.92, 6.91, Rotation2d.fromDegrees(50));
